...
namespace Floppy\Tests\Common\Storage;
...
class FilepathChoosingStrategyImplTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->strategy = new \Floppy\Common\Storage\FilepathChoosingStrategyImpl(self::DIRS_COUNT, self::CHARS_FOR_DIR, self::ORIG_DIR, self::VARIANT_DIR);
    }
